...
type Mina = {
    ...
    fetchActions: (publicKey: PublicKey, actionStates?: ActionStates, tokenId?: Field, headers?: HeadersInit) => ReturnType<typeof Fetch.fetchActions>;
 ...
 */
declare function fetchActions(publicKey: PublicKey, actionStates?: ActionStates, tokenId?: Field, headers?: HeadersInit): Promise<{
    actions: string[][];
    hash: string;
}[] | {
    error: {
