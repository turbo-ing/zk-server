...
declare const getActionsQuery: (publicKey: string, actionStates: ActionStatesStringified, tokenId: string, _filterOptions?: EventActionFilterOptions, _excludeTransactionInfo?: boolean) => string;
