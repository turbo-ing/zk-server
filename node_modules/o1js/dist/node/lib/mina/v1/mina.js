...
function Network(options) {
    ...
    return {
        ...
        async fetchEvents(publicKey, tokenId = TokenId.default, filterOptions = {}, headers) {
            ...
            return Fetch.fetchEvents({ publicKey: pubKey, tokenId: token }, archiveEndpoint, filterOptions, headers);
        },
        async fetchActions(publicKey, actionStates, tokenId = TokenId.default, headers) {
            let pubKey = publicKey.toBase58();
            let token = TokenId.toBase58(tokenId);
 ...
 */
async function faucet(pub, network = 'berkeley-qanet', headers) {
